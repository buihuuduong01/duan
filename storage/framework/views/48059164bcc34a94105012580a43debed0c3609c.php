...
<div class="main-toolbar">
    <a href="<?php echo e(route('admin.order.index')); ?>" class="btn btn-link text-silver px-0" data-bs-toggle="tooltip" data-title="Back to list"><i class="mdi mdi-chevron-left"></i> <?php _e('Back to orders'); ?></a>
</div>
...
<?php endif; ?>
<?php /**PATH C:\duan\src\MicroweberPackages\Order/resources/views/admin/orders/show.blade.php ENDPATH**/ ?>