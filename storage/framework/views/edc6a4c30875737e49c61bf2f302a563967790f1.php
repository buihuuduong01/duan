<div class="card my-3">
    <div class="card-body d-flex p-3">
        ...
        <div class="col-4 justify-content-end text-end text-right align-self-top px-0">
            <a href="<?php echo e(route('checkout.contact_information')); ?>" class="btn btn-link px-0"><?php echo e(_e('Edit')); ?></a>
        </div>

    </div>
</div>
<?php /**PATH C:\duan\src\MicroweberPackages\Checkout/resources/views/contact_information_card.blade.php ENDPATH**/ ?>