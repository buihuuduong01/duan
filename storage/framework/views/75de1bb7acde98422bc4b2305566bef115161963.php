...
<?php if (! empty(trim($__env->yieldContent('checkout_sidebar')))): ?>
...
<nav class="navbar-expand-lg checkout-v2-navbar navbar-light d-lg-none d-block">
    <div class="row">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <?php if (! empty(trim($__env->yieldContent('checkout_sidebar')))): ?>
                <?php echo $__env->yieldContent('checkout_sidebar'); ?>
            <?php else: ?>
...
<div class="row">
    ...
    <?php echo $__env->make('checkout::steps_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php /**PATH C:\duan\src\MicroweberPackages\Checkout/resources/views/layout.blade.php ENDPATH**/ ?>