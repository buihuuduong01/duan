                    ...
                    <div class="<?php print $config['module_class'] ?> user-id-<?php print $data['id']; ?>" id="users_edit_<?php echo $usersEditRand; ?>">
                        <div id="avatar_holder" class="text-center">
                            <div class="d-inline-block">
                                ...
                                <span class="text-primary mt-2 d-block"><?php _e("Avart"); ?></span>
                        ...
                        <div class="d-block">
                            <small class="d-block text-muted text-center mb-4 mt-2"><?php _e("Thông tin tài khoản "); ?></small>

                            <div class="form-group">
                                <label class="control-label"><?php _e("Tài Khoản"); ?></label>
                                <input type="text" class="form-control" name="username" value="<?php print $data['username']; ?>"/>
                            </div>


                            <div class="form-group">
                                <label class="control-label"><?php _e("Mật Khẩu "); ?></label>
                                <?php if ($data['id'] != 0): ?>
                                    <span class="mw-ui-link" onclick="reset_password();$(this).hide()"><?php _e("Quyên Mật Khẩu"); ?></span>
                                <?php endif; ?>
                            ...
                            <div class="form-group <?php if ($data['id'] != 0): ?>semi_hidden js-reset-password<?php endif; ?>">
                                <label class="control-label"><?php _e("Xác Nhận Mật Khẩu"); ?></label>
                            ...
                            <small class="d-block text-muted text-center mb-2"><?php _e("Thông tin đăng ký "); ?></small>

                            <div class="form-group">
                                <label class="control-label"><?php _e("Họ Tên"); ?></label>
                            ...
                            <div class="form-group">
                                <label class="control-label" ><?php _e("Số điện Thoại"); ?></label>
                            ...
                            <div class="form-group mt-4 mb-4">
                                <div class="custom-control custom-checkbox">
                                    ...
                                    <label class="custom-control-label" for="send_new_user_email"><?php _e("Nhận email"); ?>. <br/>
                                    </label>
                                    <br />
                            ...
                            <?php if (is_admin()) : ?>
                                <small class="d-block text-muted text-center mb-3"><?php _e("Trạng thái vai trò "); ?></small>

                                <div class="form-group">
                                    <label class="control-label mb-1"><?php _e("Phân Quyền"); ?></label>
                                    <small class="text-muted d-block mb-1"><?php _e("Vai trò "); ?>.
                                  ...
                                  <select class="selectpicker" data-live-search="true" data-width="100%" name="is_admin">
                                    ...
                                    <option value="1" <?php if( $data['is_admin'] == 1): ?> selected="selected" <?php endif; ?>>Admin</option>
                                     <option value="2" <?php if( $data['is_admin'] == 2): ?> selected="selected" <?php endif; ?>>Nhân viên</option>
                                    <option value="0" <?php if( $data['is_admin'] == 0): ?> selected="selected" <?php endif; ?>>khách hàng</option>
                                   
                                </select>
                            </div>

                            <div class="form-group">
                                <label class="control-label mb-1"><?php _e('Trạng Thái'); ?>?</label>
                                <small class="text-muted d-block mb-1"><?php _e(""); ?></small>
                                ...
                                <div class="custom-control custom-radio d-inline-block mr-3">
                                    ...
                                    <label class="custom-control-label" for="is_active1"><?php _e("Hoạt động"); ?></label>
                                </div>
                                <div class="custom-control custom-radio d-inline-block">
                                    ...
                                    <label class="custom-control-label" for="is_active2"><?php _e("Khóa"); ?></label>
                                </div>
