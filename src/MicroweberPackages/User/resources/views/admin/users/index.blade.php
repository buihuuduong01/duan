                ...
                <tr id="mw-admin-user-{{$user->id}}">
                    ...
                    <td>
                        ...
                        <a class="btn btn-outline-primary btn-sm"
                           href="{{admin_url()}}view:modules/load_module:users/edit-user:{{$user->id}}"><?php _e('xửa');?></a>
                    </td>

                    <!--  <td>

                         <a class="btn btn-outline-danger btn-sm" href="{{admin_url()}}action:delete-user/{{$user->id}}"><?php _e('xóa');?></a>
                    </td> -->
